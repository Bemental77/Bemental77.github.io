...
int4 sampleTextureWrapper(uint sampler_num, int2 uv, int layer) {
  ...
  switch(sampler_num) {
  case 0u: return sampleTexture(0u, samp[0u], uv, layer);
  case 1u: return sampleTexture(1u, samp[1u], uv, layer);
  case 2u: return sampleTexture(2u, samp[2u], uv, layer);
  case 3u: return sampleTexture(3u, samp[3u], uv, layer);
  case 4u: return sampleTexture(4u, samp[4u], uv, layer);
  case 5u: return sampleTexture(5u, samp[5u], uv, layer);
  case 6u: return sampleTexture(6u, samp[6u], uv, layer);
  case 7u: return sampleTexture(7u, samp[7u], uv, layer);
  }
}
