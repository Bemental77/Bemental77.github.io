...
// DualShockUDPClient.cpp is gated off in InputCommon/CMakeLists.txt under
// emscripten (SFML socket transport unavailable). Skip the define so the
// ControllerInterface.cpp call site doesn't reference an undefined symbol.
