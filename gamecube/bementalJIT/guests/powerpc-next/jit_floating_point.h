...
// fres (op59 sub5 24) / frsqrte (op63 sub5 26) — native full-precision reciprocal / rsqrt.
void emit_fres    (WasmModuleBuilder& wb, RegCache& rc, FPRRegCache& frc, const CodeOp& op, u32 ctx_ptr);
void emit_frsqrte (WasmModuleBuilder& wb, RegCache& rc, FPRRegCache& frc, const CodeOp& op, u32 ctx_ptr);
