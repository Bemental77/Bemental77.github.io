...
void Emulator::init()
{
	...
	// Parity-test 2026-05-19: env-var override to force interpreter mode for
	// per-instruction PC tracing in sh4_interpreter.cpp. Unset = normal behavior.
	if (const char* e = std::getenv("FLYCAST_FORCE_INTERP")) {
		if (e[0] != '0')
