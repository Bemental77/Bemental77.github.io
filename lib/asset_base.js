...
// games sat broken live with their fix committed and pushed.
//
// HOW MUCH IT SAVES IS NOT RECORDED HERE, ON PURPOSE. Which library paths are
// actually offsite is decided in ONE place — the OFFSITE block of
// deploy.exclude — and it changes as pages are converted (dreamcast/discs is
// deliberately still in the artifact while dreamcast.html's conversion is
// uncommitted). A figure copied here would be a second source of truth for a
// number that moves, and this file's whole point is that there is only one.
// The measured before/after lives beside the patterns it describes.
//
